...
class Agent:
    ...
    #     properties = Property.get_properties_by_agent(self.id)   

    #     if not properties:
    #        print(f"\n-- {self.name} has no properties listied --")
    #        return 
       
    #     print(f"\n-- Properties for {self.name} -- ")
    #     for i , propertty in enumerate(properties, start=1):
    #         print(f"{i}, address: {property.address}, price: ${property.price}.00")
    #     while True:
    #         try:
    #             selected_index = int(input("\nSelect property number for opetion(or 0 to go back): "))
    #             if selected_index = 0:
    #                 return
